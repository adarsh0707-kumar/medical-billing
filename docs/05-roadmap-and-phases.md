...
| Test coverage                           | 545 backend tests (~85% statements) with a 90% gate on the money and auth paths, 115 frontend unit tests, and a 7-flow browser smoke — all three on CI. `dashboard.controller.js` at 21.73% is the largest remaining gap |
