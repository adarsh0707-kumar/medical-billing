...
| Test coverage                           | **701 backend tests across 28 files (91.8% statements, measured 2026-08-31)** with 90% gates on the invoice, auth and dashboard paths and 100% on the shared trend query, plus **159 frontend unit tests across 19 files** and a 7-flow browser smoke — all three on CI, all measured the same day. `medicine.controller.js` at 74.5% is the largest remaining gap |
