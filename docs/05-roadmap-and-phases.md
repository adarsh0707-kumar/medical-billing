...
| Test coverage                           | 368 backend tests (~85% statements) with a 90% gate on the money and auth paths, 67 frontend unit tests, and a 6-flow browser smoke — all three on CI. `dashboard.controller.js` at 21.73% is the largest remaining gap |
