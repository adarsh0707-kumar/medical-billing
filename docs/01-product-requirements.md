...
| NFR-23 | Maintainability | Automated test coverage                                          | ✅ 327 backend tests (Vitest + Supertest), 66 frontend unit tests (Vitest + Testing Library) and a 6-flow Playwright smoke, all on CI. 90% gate on the invoice and auth paths |       |
