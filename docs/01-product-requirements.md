...
| NFR-23 | Maintainability | Automated test coverage                                          | ✅ 545 backend tests (Vitest + Supertest), 115 frontend unit tests (Vitest + Testing Library) and a 7-flow Playwright smoke, all on CI. ~85% of statements overall, with a 90% gate on the invoice and auth paths |       |
