...
| NFR-23 | Maintainability | Automated test coverage                                          | ✅ 278 backend tests on Vitest + Supertest, CI on every push, 90% gate on the invoice and auth paths. Frontend unit and E2E tests remain open |       |
