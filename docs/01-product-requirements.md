...
Password reset by email (FR-AUTH-11) · Email/SMS alerts (FR-NOTIF-06). **Both wait on the same thing** — this stack has no outbound network dependency, deliberately, and adding SMTP is one decision that unlocks both ([07 §10 P1-6](./07-security.md#10-hardening-backlog)).
