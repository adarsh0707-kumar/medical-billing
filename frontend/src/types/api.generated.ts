...
export type CustomerInput = { name: string; phone?: string | undefined; email?: string | undefined; address?: string | undefined; age?: string | number | undefined; gender?: "MALE" | "FEMALE" | "OTHER" | undefined; };

/** `customerListQuerySchema` — `backend/src/validators/billing.validator.js` */
export type CustomerListQuery = { page?: number | string | undefined; limit?: number | string | undefined; search?: string | undefined; };
...
export type UpdateProfileInput = { name?: string | undefined; email?: string | undefined; };
